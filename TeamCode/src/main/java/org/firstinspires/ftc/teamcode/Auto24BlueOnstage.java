...
@Autonomous(name="Auto24BlueOnstage", group="Autonomous")
public class Auto24BlueOnstage extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        leftPos = 0;//creates variable for the current encoder rotations
        rightPos = 0;
